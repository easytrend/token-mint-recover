#!/usr/bin/env node
/**
 * Claim-LostSol recovery CLI — recover excess SOL from a Solana token mint, entirely on
...
const PLATFORM_WALLET = new PublicKey("5xh9BFXqCgpUxGbf3QzADNze945aNSiVG9EFNa8vvb3u");
