...
[Claim-LostSol.com](https://Claim-LostSol.com): your keypair is read locally, the transaction
...
```bash
git clone https://github.com/easytrend/token-mint-recover.git
cd Claim-LostSol/cli
npm install
```
